...
const MenuNavLink = styled(ListItemButton)(({ theme }) => ({
  ...
  color: '#202224',
  padding: theme.spacing(5,2.25, 3.5,5),
  transition: 'opacity .25s ease-in-out',
  '&.active, &.active:hover': {
    boxShadow: theme.shadows[3],
    backgroundImage: `linear-gradient(98deg, #6226EF, #6226EF 94%)`
  },
...
const VerticalNavLink = ({ item, navVisible, toggleNavVisibility }) => {
  ...
  return (
    <ListItem
      ...
      sx={{ mt: 1.5, px: '0 !important',       fontSize: '14px', // Adjust the font size here
    }}
    >

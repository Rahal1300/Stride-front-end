  ...
  return (
    <Card sx={{ padding: '20px', borderRadius: '8px', width: '262px', height: '161px', textAlign: 'left', position: 'relative' }}>
      <CardContent>
        ...
        >
Total Conversion       </Typography>
        <Box sx={{ display: 'flex', alignItems: 'center', marginBottom: '20px' }}>

          <Typography variant="h4" style={{ fontSize: '24px', fontWeight: '600', fontFamily: 'Nunito Sans', margin: '0' }}>{number}</Typography>
          <img src="/images/icons/Icon3.png" style={{ marginLeft: 'auto', width: '40px', height: '40px' }} alt="Manage Icon" />
        </Box>
        <Box sx={{ display: 'flex', alignItems: 'center' }}>
        <img src="/images/icons/stonksD.png" style={{ marginLeft: 'auto', width: '24px', height: '24px' }} alt="Manage Icon" />

        <Typography style={{ color: '#00B69B', marginRight: '5px',fontFamily:'Nunito Sans',fontSize:'16px' }}>{percentage}%</Typography>
          <Typography variant="body2" style={{ fontSize: '14px', fontFamily: 'Nunito Sans', margin: '0', color: '#404040' }}>
            Up from past month
          </Typography>
        </Box>
      </CardContent>

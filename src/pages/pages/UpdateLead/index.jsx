...
<Box >
  ...
  <TextField fullWidth sx={{ backgroundColor: '#F5F6FA' }} value={leadUpdates.notes ||  ''}
...
<Grid container spacing={2}>
  <Grid item xs={6}>
    <Box >
      ...
      <TextField fullWidth sx={{ backgroundColor: '#F5F6FA' }}  value={leadUpdates.referral_email || ''}

...
const handleChangedepartement  = (event) => {
  ...
  const updatedDepartement = Array.isArray(value) ? value : [value];
...
const sendDataToServer = async () => {
  ...
  error={formSubmitted && !owner}  
  helperText={formSubmitted && !owner ? 'Please enter the project Owner' : ''}/> 
 
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField fullWidth label={t('Projects_Manager')} placeholder={t('Manager')}  value={projectsManager} 
  onChange={(e) => setProjectsManager(e.target.value)} required
  error={formSubmitted && !projectsManager}  
  helperText={formSubmitted && !projectsManager ? 'Please enter the project Manager' : ''}/> 
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField fullWidth label={t('Projects_Website')} placeholder={t('www.website.com')} value={projectwebsite} 
  onChange={(e) => setProjectwebsite(e.target.value)}required 
  error={formSubmitted && !projectwebsite}  
  helperText={formSubmitted && !projectwebsite ? 'Please enter the project website' : ''}/> 
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField fullWidth label={t('Projects_Size')} placeholder={t('1200_Km²')}   onChange={(e) => setProjectSize(e.target.value)} required
 error={formSubmitted && !projectSize}  
 helperText={formSubmitted && !projectSize ? 'Please enter the project website' : ''}/> 
                </Grid>
        ...
        <Select
          ...
          required
          value={personName}
          error={formSubmitted && !departement}  
          helperText={formSubmitted && !departement ? 'Please Select a Departement' : ''}
          ...
          {names.map((name) => (
            ...
            >
              {name}
                          ...
                          error={formSubmitted && !lod}  
                          helperText={formSubmitted && !lod ? 'Please Select a LOD' : ''}
                        >
                          ...
                          id='form-layouts-separator-select'
                          labelId='form-layouts-separator-select-label'
                          error={formSubmitted && !loi}  
                          helperText={formSubmitted && !loi ? 'Please Select a LOI' : ''}
                        >
      ...
      <RadioGroup
        ...
        error={formSubmitted && !projectLang}  
        helperText={formSubmitted && !projectLang ? 'Please Select a Language' : ''}
      >
        ...
        />
                ...
                <Grid item xs={12} sm={3}>
                  <DatePicker
                    ...
                    helperText={formSubmitted && !date ? 'Please Select a date' : ''}
                  />
                </Grid>
                <Grid item xs={12} sm={3}>
                  <DatePicker
                    ...
                    error={formSubmitted && !date2}  
                    helperText={formSubmitted && !date2 ? 'Please Select a date' : ''}
                  />
                </Grid>
                <Grid item xs={12} sm={3}>
                ...
                <Grid item xs={12} sm={3}>
                  <DatePicker
                    ...
                    error={formSubmitted && !date3}  
                    helperText={formSubmitted && !date3 ? 'Please Select a date' : ''}
                  />
                </Grid>
                ...
                <Grid item xs={12} sm={6}>
                  <TextField fullWidth label={t('Company')} placeholder={t('Company_name_here')} 
                      ...
                      error={formSubmitted && !company}  
                      helperText={formSubmitted && !company ? 'Please Select a Company' : ''}
                      />
                      
                </Grid>
                <Grid item xs={12} sm={6}>
                  <TextField fullWidth label={t('Client')} placeholder={t('Joe')}  value={client} required
    onChange={(e) => setClient(e.target.value)}
    error={formSubmitted && !client}  
    helperText={formSubmitted && !client ? 'Please Select a Client' : ''}
